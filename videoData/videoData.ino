...
char devname[30];
String devstr = "vacuumRec";

int IncludeInternet = 4; // 0 for no internet, 1 for time only, 2 streaming with WiFiMan, 3 ssid in file, 4 default internet on and file

const char *ssid = "Service Provider";
const char *password = "@Matinik298-2021";

// https://sites.google.com/a/usapiens.com/opnode/time-zones  -- find your timezone here
String TIMEZONE = "ULAT-8ULAST,M3.5.0/2,M9.5.0/2";
...
bool init_wifi()
{
    ...
    else
    {
        ...
        if (res)
        {
            ...
            while (now < 15)
            { // try for 5 seconds to get the time, then give up - 10 seconds after boot
                delay(1000);
                Serial.print("o");
                time(&now);
            }
