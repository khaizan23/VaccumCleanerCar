...
const char* ssid = "Service Provider";      //--> Enter your SSID / your WiFi network name.
const char* password = "@Matinik298-2021";  //--> Enter your WiFi password.
/* ======================================== */

/* ======================================== Variables for telegram bot tokens. */
String BOTtoken = "5851134277:AAEU1QH1EdwdX129JDnE2Iw3P9FFtyNTpwo";  //--> your Bot Token (Get from Botfather).
/* ======================================== */

/* ======================================== @myidbot ID */
// Use @myidbot to find out the chat ID of an individual or a group.
// Also note that you need to click "start" on a bot before it can message you.
String CHAT_ID = "6293305168";
/* ======================================== */
