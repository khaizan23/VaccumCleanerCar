...
void setup() {
  ...
  salengGSM.sendSMS("09123456789", "Hi, THE ROBOT HAS BEEN BOOTED Have a nice day!");
...
void loop() {
  ...
  if (battery < lowBattery) {
    if (once) {
      salengGSM.sendSMS("09123456789", "Hi, THE ROBOT HAS a low battery please charge the battery");
      salengGSM.smsMachine();
